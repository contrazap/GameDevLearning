...
**Folder/repo:** `A1_Flappy` · **Clone of:** Flappy Bird · **Platform:** Windows · **Est:** 8 sessions · **Blender:** none · **UE template:** Blank (Blueprint)
...
**Scope — In:** one bird, endless pipes, score + high score, start/death/restart flow, packaged Windows build, free/placeholder art and sfx.
...
UMG (first encounter → guided): in-game score HUD, start screen, game-over panel with score/best. High score persisted via **SaveGame** (first encounter → guided). Then the first **packaged Windows build** — packaging is part of finishing, every project ends with it. Done means: a stranger could download the zip and play.
