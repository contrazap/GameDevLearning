...
**Folder/repo:** `A3_Chess` · **Clone of:** Chess · **Platform:** Linux · **Est:** 14 sessions · **Blender:** none (free piece meshes or primitives) · **UE template:** Blank (Blueprint), converted to C++ at A3.3
...
Minimax with material evaluation in C++ (rep 2 → how-to), searching 2–3 plies; the AI plays legally and punishes blunders. Move animation (lerp + capture removal), move/capture/check sfx, packaged Linux build (packaging rep → story: no steps, just the criterion).
