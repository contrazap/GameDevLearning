...
- ✅ **S0.1** Planning repo on GitHub + the per-project spin-up ritual (templates, verification, first dry run) (1–2) — [features/S0-repos-and-spinup.md](features/S0-repos-and-spinup.md)
- ✅ **S0.2** Arch Linux workstation: UE 5.8 Linux editor, git-lfs, Vulkan sanity, uv — added by the 2026-07-23 Linux migration; gates A1.1 (1) — [features/S0.2-arch-linux-setup.md](features/S0.2-arch-linux-setup.md)
...
- ⬜ **A1.3** UI, save & first package: UMG HUD + menus, high-score SaveGame, packaged Linux build (2)
...
**C1 — Traversal** (Prince of Persia: WW · Linux · 20)
...
**C2 — Souls arena** (Dark Souls 2 · Linux · 20)
...
**C3 — StealthOps** (Project IGI, GTFO solo, PUBG gunplay · Linux · 18)
...
**D2 — Survival** (Don't Starve Together 3D topdown, Zomboid · Linux · 20)
...
**E1 — Offroad** (SnowRunner · Linux · 16)
...
**E2 — Chained** (Chained Together, solo · Linux · 8)
...
**E3 — Expanse** (Star Citizen notes: landmarks + control modes · Linux · 14)
...
**E4 — MicroRTS** (Age of Empires · Linux · 18)
...
- ⬜ **F1.5** Perf, polish & ship: profiling pass, budgets, packaged Linux (+📱 if the title fits) (3)
