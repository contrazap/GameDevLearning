...
**Folder/repo:** `D3_Horde` · **Clone of:** Vampire Survivors · **Platforms:** Windows + Android · **Est:** 16 sessions · **Blender:** none required (free/flat assets fit the genre) · **UE template:** Top Down (C++)
...
The feel pass: hit flashes, damage numbers settling, screen shake (restrained), kill sfx layering, gem vacuum moments; Niagara rep 3 (→ story); packages for Windows + Android with per-platform enemy ceilings from D3.3's measurements (→ story).
